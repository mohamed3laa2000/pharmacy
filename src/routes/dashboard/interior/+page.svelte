<script>
    ...
    async function loadMedicines(initial = true) {
        ...
        let q = query(
            ...
            where('category', '==', 'أدوية الوصفات الداخلية'),
            orderBy('name'),
            limit(pageSize)
        );
    ...
    let newMedicine = { name: '', category: 'أدوية الوصفات الداخلية', unit: '' };
    ...
    async function addMedicine() {
        ...
        newMedicine = { name: '', category: 'أدوية الوصفات الداخلية', unit: '' };
