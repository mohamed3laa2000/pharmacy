		...
		<div class="bg-white dark:bg-gray-800 p-6 rounded-lg w-[90%] md:w-[500px]">
			...
			<form on:submit|preventDefault={() => handleSubmit(addMedicine)}>
				...
				>
					...
					<option value="المؤثرات العقلية">المؤثرات العقلية</option>
					<option value="الأدوية الخاضعة للرقابة">الأدوية الخاضعة للرقابة</option>
					<option value="أدوية الوصفات الداخلية">أدوية الوصفات الداخلية</option>
					<option value="أدوية وصفتي">أدوية وصفتي</option>
